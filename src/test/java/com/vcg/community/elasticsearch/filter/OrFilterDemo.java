...
/**
 * @see <a>https://www.elastic.co/guide/en/elasticsearch/client/java-api/1.5/or-filter.html</a>
 * @author lei.fang
 * @since 2017/3/8
 */
public class OrFilterDemo extends BaseDemo {

    @Test
    public void test(){

        FilterBuilder filterBuilder = FilterBuilders.orFilter(
                FilterBuilders.termFilter("title","美女"),
                FilterBuilders.termFilter("title","豪车")
        );
