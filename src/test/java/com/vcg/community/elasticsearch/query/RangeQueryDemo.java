...
/**
 * @see <a>https://www.elastic.co/guide/en/elasticsearch/client/java-api/1.5/java-range.html</a>
 * @author lei.fang
 * @since 2016/12/22
 */
public class RangeQueryDemo extends ElasticDemo {

    @Test
    public void test(){

        QueryBuilder qb = QueryBuilders.rangeQuery("resourceType")
                .from(-1)
                .to(10)
                .includeLower(true)
                .includeUpper(true);
