...
/**
 * @see <a>https://www.elastic.co/guide/en/elasticsearch/client/java-api/1.5/not-filter.html</a>
 * @author lei.fang
 * @since 2017/3/8
 */
public class NotFilterDemo extends BaseDemo {

    @Test
    public void  test(){
        FilterBuilder filterBuilder = FilterBuilders.notFilter(
                FilterBuilders.rangeFilter("rating")
                .from(0.0d)
                .to(100.0d)
        );
